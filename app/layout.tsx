...
export const metadata: Metadata = {
  ...
  description: "Informações sobre cursos, regras, cidades, profissões e procura no Vestibular Unesp.",
  openGraph: {
    title: "Assistente Vestibular Unesp 2027",
    description: "Cursos, cidades, carreiras e procura explicados para estudantes.",
